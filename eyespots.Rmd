...
Design did not have a significant effect on the likelihood of predation (χ² 2,1033 = 3.1, P = 0.2). 
...
A descriptive summary of the raw data indicated there may be a difference in predation levels of models containing a 'sparkle' compared to other designs at location 1, but in location 2, predation levels were almost equal for all designs. Due to this observation, an interaction term between location and design was added to the model. The indication of a potential interaction was supported by the predicted probabilities of predation in each location (figure 2).
